import{i as R,n as N,p as U,d as o,o as r,c,a as e,b as d,k as u,t as i,x as k,f as $,I as j,E as H,y as A,z as P,S as O,j as x,g as B,D as X,m as q,h as Y}from"./index-CMw9hxE7.js";import{f as G}from"./useFormato-D2DftH4l.js";import{A as J,C as K}from"./AlertMessage-H7usXc5Q.js";import{C as Q}from"./ConfirmModal-CPaXV4W9.js";import{U as W,P as Z,A as E,a as _}from"./user-x-AXlIKNsM.js";import{C as tt}from"./circle-check-DsVpfloK.js";import{L as et}from"./landmark-BD4fLlR6.js";import{P as ot}from"./pencil-Du4mIyTh.js";import{B as nt}from"./ban-DYK_EXiK.js";/**
 * @license lucide-vue-next v0.577.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const at=R("briefcase",[["path",{d:"M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16",key:"jecpp"}],["rect",{width:"20",height:"14",x:"2",y:"6",rx:"2",key:"i6l2r4"}]]),it={key:0,class:"detalle-beneficiario"},lt={class:"page-header"},st={class:"sections"},dt={key:0},rt={style:{"margin-left":"0.5rem",color:"var(--text-secondary)"}},ut={key:1,style:{color:"var(--text-muted)","font-size":"0.85rem"}},ct={key:1,class:"card-section"},mt={class:"data-table"},pt={class:"actions"},ft={key:1,class:"loading"},bt={key:2,class:"empty-state"},zt={__name:"DetalleBeneficiario",props:{rut:{type:[String,Number],required:!0}},setup(z){const F=z,n=N(),M=Y(),b=B(""),y=B("info"),C=B(!1),w=X(()=>{var t;const a=(t=n.detalle)==null?void 0:t.tipoCuenta;return a===1?"Cuenta Corriente":a===2?"Ahorro / CuentaRUT":a===3?"Cuenta Vista":"-"});U(()=>{n.detalle=null,n.obtener(Number(F.rut))});function s(a){const t=document.createElement("div");return t.textContent=a??"",t.innerHTML}function V(){var L,S;const a=n.detalle,t=new Date().toLocaleDateString("es-CL"),p=a.sexo==="M"?"Masculino":a.sexo==="F"?"Femenino":"-",g=w.value,v=a.ctaEstado||a.ctaOtBanco||"-",l=a.nombreBanco||a.codBanco||"-";let f="";(L=a.funcionarios)!=null&&L.length?f=a.funcionarios.map(m=>`<div style="margin-bottom: 3px;"><strong>${s(m.rutFormateado)}</strong> <span style="color: #64748b; margin-left: 6px;">${s(m.nombreCompleto)}</span></div>`).join(""):f='<p class="muted">Sin funcionarios asociados.</p>';let h="";(S=a.retenciones)!=null&&S.length?h=`<table class="ret-table">
